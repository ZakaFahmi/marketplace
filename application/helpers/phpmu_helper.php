<?php 
    ...
    function status($str){
        if ($str=='0'){
            $data = "<i class='text-danger' style='color:#cecece !important'>Pending</i>";
        }elseif($str=='1'){
            $data = "<i class='text-info'>Proses</i>";
        }elseif($str=='2'){
            $data = "<i class='text-warning'>Konfirmasi</i>";
        }elseif($str=='3'){
            $data = "<i class='text-success'>Success</i>";
        }
        return $data;
    }
