    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class='alert alert-success alert-dismissible fade in' role='alert' style='border-radius:0px; margin-bottom:0px'>
          ...
          <a href="#" style="margin-right:10px; text-decoration:none;">lebih lengkap disini : </a>
          <a target='_BLANK' class="btn btn-default btn-sm" href="#" style="color:red;">Marketplace</a>
        </div>
      <?php } ?>
