      ...
      <table class="table table-striped table-condensed">
        ...
        <?php 
          ...
          echo "
                ...
                <tr><td align=center colspan='4'><b>".status($rows['proses'])."</b></td></tr>

        </tbody>
      </table>";
      if ($rows['resi']!=''){
        echo "<p>Nomor Resi (<span style='text-transform:uppercase; color:red; font-weight:bold'>$rows[kurir]</span>) Pesanan <b>$rows[resi]</b> <br>Telusuri Pesanan <a target='_BLANK' href='https://cekresi.com/?v=wdg&noresi=$rows[resi]'><u>disini</u></a></p>";
      }
?>
</div>
